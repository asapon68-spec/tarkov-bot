...
# ====== 以下に武器・弾薬の辞書が続く（2/2で送る） ======
# ========================================
# 🔫 武器・銃器類（アサルト / カービン / DMR / SMG / LMG）
# ========================================
...
CANONICAL_ITEMS += [
    ...
    },
    {
        ...
        "aliases": ["ak103", "103", "エーケー103"],
    },
    {
        "name": "Kalashnikov AK-104 7.62x39 assault rifle",
        "aliases": ["ak104", "104", "短103"],
    },
    {
    ...
    },
    {
        ...
        "aliases": ["akm", "エーケーエム", "m木スト"],
    },
    {
        "name": "Kalashnikov AKMN 7.62x39 assault rifle",
        "aliases": ["akmn", "mn", "akmn 木"],
    },
    ...
    },
    {
        ...
        "aliases": ["hk416", "416", "416a5", "エイチケー416"],
    },
    {
    ...
    },
    {
        ...
        "aliases": ["pkp", "ぺチェ", "ぺチェネグ"],
    },
    {
        "name": "RPK-16 5.45x39 light machine gun",
        "aliases": ["rpk16", "rpk-16", "エルピーケー16"],
    },
...

    {
        ...
        "aliases": ["g17", "glock17", "グロック17"],
    },
    {
        "name": "Glock 18C 9x19 pistol",
        "aliases": ["g18", "glock18", "18c"],
    },
    {
...
for item in CANONICAL_ITEMS:
    ...
    for alias in item["aliases"]:
        ...
        ITEM_ALIASES.setdefault(key, name)
